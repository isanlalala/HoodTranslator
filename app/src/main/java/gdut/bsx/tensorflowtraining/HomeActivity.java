...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String MODEL_FILE = "file:///android_asset/model/tflite_graph.pb";
    private static final String LABEL_FILE = "file:///android_asset/model/tflite_graph.txt";
    ...
    MessageQueue.IdleHandler idleHandler = new MessageQueue.IdleHandler() {
        ...
        public boolean queueIdle() {
            ...
            if (classifier == null) {
                classifier = TensorFlowImageClassifier.create(HomeActivity.this.getAssets(),
    ...
    private void showNeedStoragePermissionDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("must have permission to access photos")
    ...
    private void showMissingStoragePermissionDialog() {
        new AlertDialog.Builder(this)
                .setTitle("get permission failed")
                .setMessage("must have permission to access photos")
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override public void onClick(DialogInterface dialog, int which) {
    ...
    private void handleInputPhoto(Uri imageUri) {
        GlideApp.with(HomeActivity.this).asBitmap().listener(new RequestListener<Bitmap>() {

            @Override
            public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Bitmap> target, boolean isFirstResource) {
                Log.d(TAG,"handleInputPhoto onLoadFailed");
                Toast.makeText(HomeActivity.this, "Load photo failed", Toast.LENGTH_SHORT).show();
                return false;
            }
